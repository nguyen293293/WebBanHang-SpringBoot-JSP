  ...
  <div class="row">
    ...
    <div class="col-9">
      ...
      <nav aria-label="Page navigation example">
        <ul class="pagination">
          <li class="page-item"><a class="page-link" href="?p=0&keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}">&laquo;</a></li>
          <li class="page-item"><a class="page-link" href="?p=${productList.number-1 < 0 ? 0 : productList.number-1}&keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}">&lsaquo;</a></li>
          <li class="page-item"><a class="page-link"
                                   href="?p=${productList.number+1 > productList.totalPages-1 ? productList.totalPages-1 : productList.number+1}&keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}">&rsaquo;</a></li>
          <li class="page-item"><a class="page-link" href="?p=${productList.totalPages-1}&keyword=${param.keyword}&categoryId=${param.categoryId}&priceRangeId=${param.priceRangeId}">&raquo;</a></li>
        </ul>
      </nav>
    </div>
  </div>
